...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    role: "Technical Lead",
    period: "2021 - 2022",
    summary: "Managed technical aspects of TEDx events including website and streaming solutions.",
    description:
  ...
  },
  {
    ...
    period: "2020 - 2021",
    summary: "Led web development workshops and mentored students in modern web technologies.",
    description:
  ...
  },
  {
    ...
    period: "2019 - 2020",
    summary: "Developed React and Next.js applications for various startup clients.",
        ...
        {experiences.map((exp) => (
          <HoverCard key={exp.id}>
            <HoverCardTrigger asChild>
              <button
                className="group relative bg-gray-800/50 p-6 rounded-lg hover:bg-gray-800/70 transition-all duration-300 w-full h-full"
              >
                ...
                <p className="text-sm text-gray-400 group-hover:text-cyan-400 transition-colors">{exp.role}</p>
              </button>
            </HoverCardTrigger>
            <HoverCardContent className="w-80 bg-gray-900 border-gray-800">
              <div className="flex justify-between space-x-4">
                <div className="space-y-1">
                  <h4 className="text-sm font-semibold text-cyan-400">{exp.role}</h4>
        ...
        {selectedExperience && (
          <DialogContent className="sm:max-w-[600px] bg-gray-900 text-white border-gray-800">
            <DialogHeader>
              ...
              <DialogTitle className="text-xl font-semibold">{selectedExperience.role}</DialogTitle>
              <DialogDescription className="text-gray-400">{selectedExperience.period}</DialogDescription>
            </DialogHeader>
            <div className="space-y-6">
              ...
              {selectedExperience.testimonial && (
                <div className="border-l-2 border-cyan-400 pl-4 mt-6">
                  <blockquote className="text-gray-300 italic">"{selectedExperience.testimonial.text}"</blockquote>
                  <div className="mt-4">
                    <p className="font-medium">{selectedExperience.testimonial.author}</p>
                    <p className="text-sm text-gray-400">{selectedExperience.testimonial.position}</p>
                  </div>
                </div>
              )}
            </div>
